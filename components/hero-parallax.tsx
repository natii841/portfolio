  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-muted-foreground">
        No-code platform. Powerful agents. Zero infrastructure headaches.
        <br className="hidden md:block" />
        Build autonomous workflows that scale with your business.
      </p>
      <Link
        href="#features"
        className="mt-8 inline-flex h-12 items-center justify-center rounded-full bg-gradient-to-r from-violet-600 via-purple-600 to-cyan-500 px-8 text-sm font-medium text-white shadow-lg shadow-violet-500/25 transition-all duration-300 hover:scale-105 hover:shadow-violet-500/40"
      >
        Start Building Free
        <svg
